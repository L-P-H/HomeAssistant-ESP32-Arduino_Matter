...
void loop() {
  ...
  if (client) {                             // if you get a client,
    ...
    Serial.println(Data);
    if (Data == 1) {Temp_ = 2; Hum_ = 2; SendToDisplay(Temp, Temp_ , Hum, Hum_, Moist, Moist_); analogWrite(14, 255);}
    else if (Data == 2) {Moist_ = 2; SendToDisplay(Temp, Temp_ , Hum, Hum_, Moist, Moist_); analogWrite(14, 255);}
    else if (Data >= 1000 && Data <= 2000) {Data -= 1000; Moist = Data / 10; analogWrite(16, 250); Moist_ = 1; Print();}
    else if (Data > 1000000 && Data < 2000000) {Data -= 1000000; Temp = Data / 10000; Hum = (Data-1000*int(Data/1000)) / 10; analogWrite(15, 250); Temp_ = 1; Hum_ = 1; Print();}
